...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url(); ?>assets/compiled/svg/favicon.svg" type="image/x-icon">
            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="index.html"><img src="<?php echo base_url(); ?>assets/compiled/svg/logo.svg" alt="Logo" srcset=""></a>
                        </div>
                                                ...
                                                <tbody>
                                                        ...
                                                        <td class="col-3">
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar avatar-md">
                                                                    <img src="<?php echo base_url(); ?>assets/compiled/jpg/5.jpg">
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td class="col-3">
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar avatar-md">
                                                                    <img src="<?php echo base_url(); ?>assets/compiled/jpg/2.jpg">
                                                                </div>
                            ...
                            <div class="card-body py-4 px-4">
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-xl">
                                        <img src="<?php echo base_url(); ?>assets/compiled/jpg/1.jpg" alt="Face 1">
                                    </div>
                                    <div class="ms-3 name">
                            ...
                            <div class="card-content pb-4">
                                <div class="recent-message d-flex px-4 py-3">
                                    <div class="avatar avatar-lg">
                                        <img src="<?php echo base_url(); ?>assets/compiled/jpg/4.jpg">
                                    </div>
                                    <div class="name ms-4">
